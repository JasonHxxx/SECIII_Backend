...
import team.software.collect.similarity.textSimilarity.similarity.util.DicReader;
...
import team.software.collect.similarity.textSimilarity.similarity.word.IWordSimilarity;
import team.software.collect.similarity.textSimilarity.similarity.word.hownet.IHownetMeta;
import team.software.collect.similarity.textSimilarity.similarity.word.hownet.sememe.SememeParser;
...
public abstract class ConceptParser implements IHownetMeta, IWordSimilarity {
    ...
    private double getSimilarityAVG(String[] sememes1, String[] sememes2) {
        ...
        // calculate team.software.collect.similarity of two set
        ...
        // get max team.software.collect.similarity score
